...
- Before handoff, run `python3 -m unittest discover -s tests -v` and `python3 scripts/validate_repo.py .`. Run `python3 scripts/run_evals.py --cases evals/cases` when eval fixtures change.
